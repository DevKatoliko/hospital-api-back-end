...
public class MedicalRecord {
	...
	@ElementCollection
	@CollectionTable(name = "medical_records_history", joinColumns = @JoinColumn(name = "medical_record_id"))
	private List<MedicalRecord> medicalRecordsHistory;// Here is the repository to keep all medical records of a patient
	
	protected MedicalRecord() {}
	
	public MedicalRecord(Doctor doctor, Patient patient, List<String> symptoms) {
		this.doctor = doctor;
