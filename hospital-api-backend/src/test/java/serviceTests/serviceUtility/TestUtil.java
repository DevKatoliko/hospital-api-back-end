...
public class TestUtil {
	...
	public PatientCreationDTO setUpMockPatientCreationDTO() {
		var personDTO = setUpMockPersonCreationDTO();
	...
	public PatientCreationDTO setUpMockPatientUpdate() {
		var mockPatientCreationDTO = setUpMockPatientCreationDTO();
		var mockPersonCreationDTO = setUpMockPersonCreationDTO();
		return new PatientCreationDTO(mockPersonCreationDTO,"Motorista",mockPatientCreationDTO.mothersName());
	}
	
	public Patient convertMockPatientDTOToMockEntity(PatientCreationDTO patientDTO) {
